                                ...
                                <div class="col-md-8 ml-auto mr-auto">
                                    <form role="form" id="form-validation" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <label for="img-upload" class="pointer">
                                                        @if($post->image != '')
                                                            <img id="uploadPreview" src="{{asset('blogs/'.$post->image)}}" width="118" alt="">
                                                        @else
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="seo_title" id="seo_title" value="{{$post->seo_title}}" placeholder="Seo Title">
                                                </div>
                                            </div>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="description" id="description" value="{{$post->description}}" placeholder="description">
                                                </div>
                                            </div>
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Image Alt Tag</label>
                                                    <input type="text" class="form-control" name="image_slug" id="image_slug" value="{{$post->image_slug}}" placeholder="image alt tag">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="meta_keyword" id="meta_keyword" value="{{$post->meta_keyword}}" placeholder="Keyword">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Content</label>
                                                    <textarea class="form-control" rows="3" id="summernote-usage" name="content" required>{{$post->content}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <select class="selectize-group" name="parent_cat_id" required="" onchange="getSubCategories(value)">
                                                        ...
                                                        @if(count($parent_categories) > 0)
                                                            @foreach($parent_categories as $row)
                                                                <option value="{{$row->cat_id}}" <?php if($post->parent_cat_id == $row->cat_id){ ?> selected="" <?php } ?>>{{$row->cat_title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                                        ...
                                                        <select class="selectize-group" name="cat_id" required="">
                                                            ...
                                                            @if(count($sub_categories) > 0)
                                                                @foreach($sub_categories as $row)
                                                                    <option value="{{$row->cat_id}}" <?php if($post->cat_id == $row->cat_id){ ?> selected="" <?php } ?>>{{$row->cat_title}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Tags</label>
                                                    <input type="text" class="form-control" name="tags" id="tags" value="{{$post->tags}}" placeholder="tags">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="checkbox ">
                                                    <input id="form-2-1" name="is_approved" type="checkbox" <?php if($post->is_approved == 1){ ?> checked="" <?php } ?> >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="checkbox ">
                                                    <input id="form-2-2" name="isIndex" type="checkbox" <?php if($post->isIndex == 1){ ?> checked="" <?php } ?> >
