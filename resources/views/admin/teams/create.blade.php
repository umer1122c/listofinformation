                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="memberName" id="memberName" value="{{Request::old('memberName')}}" placeholder="Client Member" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="memberDesignation" id="memberDesignation" value="{{Request::old('memberDesignation')}}" placeholder="Designation" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="memberInformation" placeholder="Project Description" required>{{Request::old('memberInformation')}}</textarea>
                                                </div>
                                            </div>
                                        </div>
