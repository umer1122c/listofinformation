                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-block">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{URL::to('/admin/listing/add/'.$type)}}"><button id="editable-sample_new" class="btn btn-primary">Add New <i class="fa fa-plus"></i></button></a>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="relative mrg-top-15">
                                                            <span class="">{{$row->listing_id}}</span>
                                                        </div>
                                                    </td>
                                                    <td width="28%">
                                                        <div class="relative mrg-top-15">
                                                            <span class="">{{$row->listing_title}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="relative mrg-top-15">
                                                            {{-- <span class="pdd-left-20">{{$row->image}}</span> --}}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="relative mrg-top-15">
                                                            <span class="pdd-left-20">{{$row->is_approved}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="relative mrg-top-15">
                                                            <span class="pdd-left-20">{{$row->listing_slug}}</span>
                                                        </div>
                                                    </td>
                                                     <td>
                                                        <div class="relative mrg-top-15">
                                                            <span class="pdd-left-20">{{$row->parent_cat_id}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="relative mrg-top-15">
                                                            <span class="pdd-left-20">{{$row->cat_id}}</span>
                                                        </div>
                                                    </td>
<!--                                                    <td>
                                                        @if($row->is_season == '1')
...
<!--                                                    <td>
                                                    ...
                                                    <td width='22%'>
                                                        <a href="{{URL::to('admin/product/edit/'.$row->id)}}" class="btn btn-info">
...
<script type="text/javascript"> 
    ...
    function delete_confirm(){
        if(delID != 0){
            window.location = APP_URL+'/admin/product/delete/'  + delID;
        }
    } 
