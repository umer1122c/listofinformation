                                    ...
                                    <form role="form" id="form-validation" action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <select class="selectize-group" name="country_id" id="country_id" required="" >
                                                        ...
                                                        @if(count($countries) > 0)
                                                            @foreach($countries as $row)
                                                                <option value="{{$row->id}}" @if($city->country_id == $row->id) selected @endif>{{$row->name}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control" name="name" id="name" value="{{$city->name}}" placeholder="Name">
                                                </div>
                                            </div>
                                        </div>
