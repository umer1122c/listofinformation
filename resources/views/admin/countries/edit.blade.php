                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <label for="img-upload" class="pointer">
                                                        @if($country->image != '')
                                                            <img id="uploadPreview" src="{{asset('countries/'.$country->image)}}" width="118" alt="">
                                                        @else
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control" name="name" id="name" value="{{$country->name}}" placeholder="Name" required>
                                                </div>
                                            </div>
                                        </div>
