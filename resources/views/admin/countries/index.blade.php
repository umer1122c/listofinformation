                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-block">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{URL::to('admin/country/add')}}"><button id="editable-sample_new" class="btn btn-primary">Add New <i class="fa fa-plus"></i></button></a>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="list-info mrg-top-10">
                                                            @if($row->image != '')
                                                                <img class="thumb-img" src="{{asset('countries/'.$row->image)}}" alt="">
                                                            @else
                                                    ...
                                                    <td width='25%'>
                                                        <a href="{{URL::to('admin/country/edit/'.$row->id)}}" class="btn btn-info">
...
<script type="text/javascript"> 
    ...
    function delete_confirm(){
        if(delID != 0){
            window.location = APP_URL+'/admin/country/delete/'  + delID;
        }
    } 
