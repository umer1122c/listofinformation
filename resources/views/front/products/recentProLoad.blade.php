<section class="openpally-wrapper position-relative recently-bg">
    <div class="container">
        <div class="row justify-content-center left-head">
            <div class="col-md-12 col-lg-12">
                <div class="main-heading ">
                    <h3 class="font-weight-bold mb-0 text-uppercase">RECENTLY VIEWED</h3>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12 col-lg-12">
                @if(count($recentaly_products) > 0)
                    <div id="openpallyslider">
                        <div class="arrows1">
                        ...
                        <div class="MS-content">
                            @foreach($recentaly_products as $row_rec)
                                <?php 
